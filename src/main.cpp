...
pros::MotorGroup leftMotors({-3, 2, -1},
                            pros::MotorGearset::blue); // left motor group - ports 1 (reversed), 2, 3 (reversed)
pros::MotorGroup rightMotors({6, -5, 4}, pros::MotorGearset::blue); // right motor group - ports 4, 5, 6 (reversed)
...
// vertical tracking wheel encoder. Rotation sensor, port 9, reversed
...
void autonomous() {
	...
	*/
	dsr_system.start_location_recording("TESTING");
