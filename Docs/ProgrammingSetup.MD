...
This section goes over how to setup TitanReset with LemLib specifically. This will not go over LemLib setup and will assume that either is already setup for your robot.
